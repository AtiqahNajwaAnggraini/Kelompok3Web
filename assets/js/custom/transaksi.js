...
function checkStok() {
    $.ajax({
        ...
        success: res => {
            ...
            if (stok < jumlah) Swal.fire("Gagal", "Maaf,Stok Barang Tidak Cukup", "warning");
            else {
                ...
                if (a.length > 0) {
                    ...
                    if (stok < data[3] + jumlah) {
                        Swal.fire('stok', "Maaf, Stok Barang Tidak Cukup", "warning")
                    } else {
...
function add() {
    ...
    $.ajax({
        ...
        success: res => {
            if (isCetak) {
                Swal.fire("Sukses", "Pembayaran Sukses", "success").
