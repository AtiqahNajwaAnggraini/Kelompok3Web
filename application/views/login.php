      ...
      <div class="row align-items-center h-100">
        <form method="post" action="auth-check" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.html">
            ...
            <img src="<?=base_url();?>assets/assets/avatars/POLKAM.png" alt="..." style="width:60px;height:60px;">
          </a>
          <h1 class="h6 mb-3"></h1>
          <h4 class="mb-2" style="text-align: center;">Welcome To PolkaMart</h4>
<br>
          <div class="mb-3">
          ...
          <button class="btn btn-lg btn-info btn-block" style="background-color: orange; color: black;" type="submit">Login</button>
          <p class="mt-5 mb-3 text-muted">©  Kelompok 3 Tif B 2020</p>
        </form>
      </div>
    </div>
